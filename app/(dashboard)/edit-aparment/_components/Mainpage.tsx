...
//         state: data.address.split(",")[2]?.split(" ")[0]?.trim() || "",
//         zipCode: data.address.split(",")[2]?.split(" ")[1]?.trim() || "",
//       },
//       price: parseFloat(data.price) || 0,
//       bedrooms: parseInt(data.beds) || 0,
//       bathrooms: parseInt(data.bathrooms) || 0,
//       squareFeet: parseInt(data.squarefeet) || 0,
//       description: data.description,
//       aboutListing: data.aboutListing,
//       day: data.day,
//       availableFrom: {
//         month: data.month || "",
//         time: data.availableTime || "",
//       },
//       // Note: Images and videos are not included in the PUT request as the API endpoint wasn't specified to handle file uploads
//     }),
//   });
//   if (!response.ok) {
...
//   // Set default form data when API data is available
//   React.useEffect(() => {
//     if (data?.data) {
//       const { data: apartment } = data;
//       setFormData({
//         title: apartment.title,
//         address: `${apartment.address.street}, ${apartment.address.city}, ${apartment.address.state} ${apartment.address.zipCode}`,
//         price: apartment.price.toString(),
//         beds: apartment.bedrooms.toString(),
...
//         availableTime: new Date(apartment.availableFrom.time).toLocaleTimeString(),
//       });
...
//   if (error) {
//     return <div className="text-red-500 p-4">Error loading apartment data</div>;
//   }

//   return (
//     <div className="min-h-screen">
//       {/* Header */}
//       <Header tittle={id ? "Edit Apartment Listing" : "Add Apartment Listing"} />

//       {/* Breadcrumb */}
//       <Bradecumb pageName="Apartment Listings" subPageName={id ? "Edit Apartment Listing" : "Add Apartment Listing"} />
